...
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', '/bin/sh -c \'( umask 77 && mkdir -p "` echo /root/.ansible/tmp `"&& mkdir "` echo /root/.ansible/tmp/ansible-tmp-1644758562.6752458-52650-70863232425361 `" && echo ansible-tmp-1644758562.6752458-52650-70863232425361="` echo /root/.ansible/tmp/ansible-tmp-1644758562.6752458-52650-70863232425361 `" ) && sleep 0\'']
...
<centos7> PUT /root/.ansible/tmp/ansible-local-52645m60ddudn/tmp137wb9r8 TO /root/.ansible/tmp/ansible-tmp-1644758562.6752458-52650-70863232425361/AnsiballZ_setup.py
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'chmod u+x /root/.ansible/tmp/ansible-tmp-1644758562.6752458-52650-70863232425361/ /root/.ansible/tmp/ansible-tmp-1644758562.6752458-52650-70863232425361/AnsiballZ_setup.py && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c '/usr/bin/python /root/.ansible/tmp/ansible-tmp-1644758562.6752458-52650-70863232425361/AnsiballZ_setup.py && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'rm -f -r /root/.ansible/tmp/ansible-tmp-1644758562.6752458-52650-70863232425361/ > /dev/null 2>&1 && sleep 0'"]
ok: [centos7]
META: ran handlers
...
<centos7> ESTABLISH DOCKER CONNECTION FOR USER: root
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'echo ~ && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', '/bin/sh -c \'( umask 77 && mkdir -p "` echo /root/.ansible/tmp `"&& mkdir "` echo /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166 `" && echo ansible-tmp-1644758567.935719-52905-55056646943166="` echo /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166 `" ) && sleep 0\'']
Using module file /usr/local/lib/python3.8/dist-packages/ansible/modules/stat.py
<centos7> PUT /root/.ansible/tmp/ansible-local-52645m60ddudn/tmpej66ph7g TO /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166/AnsiballZ_stat.py
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'chmod u+x /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166/ /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166/AnsiballZ_stat.py && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c '/usr/bin/python /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166/AnsiballZ_stat.py && sleep 0'"]
Using module file /usr/local/lib/python3.8/dist-packages/ansible/modules/file.py
<centos7> PUT /root/.ansible/tmp/ansible-local-52645m60ddudn/tmpdt3wxh36 TO /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166/AnsiballZ_file.py
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'chmod u+x /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166/ /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166/AnsiballZ_file.py && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c '/usr/bin/python /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166/AnsiballZ_file.py && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'rm -f -r /root/.ansible/tmp/ansible-tmp-1644758567.935719-52905-55056646943166/ > /dev/null 2>&1 && sleep 0'"]
ok: [centos7] => {
    "attempts": 1,
    "changed": false,
...
<centos7> ESTABLISH DOCKER CONNECTION FOR USER: root
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'echo ~ && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', '/bin/sh -c \'( umask 77 && mkdir -p "` echo /root/.ansible/tmp `"&& mkdir "` echo /root/.ansible/tmp/ansible-tmp-1644758572.6873014-53129-261001537130544 `" && echo ansible-tmp-1644758572.6873014-53129-261001537130544="` echo /root/.ansible/tmp/ansible-tmp-1644758572.6873014-53129-261001537130544 `" ) && sleep 0\'']
Using module file /usr/local/lib/python3.8/dist-packages/ansible/modules/file.py
<centos7> PUT /root/.ansible/tmp/ansible-local-52645m60ddudn/tmpqazj2py3 TO /root/.ansible/tmp/ansible-tmp-1644758572.6873014-53129-261001537130544/AnsiballZ_file.py
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'chmod u+x /root/.ansible/tmp/ansible-tmp-1644758572.6873014-53129-261001537130544/ /root/.ansible/tmp/ansible-tmp-1644758572.6873014-53129-261001537130544/AnsiballZ_file.py && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c '/usr/bin/python /root/.ansible/tmp/ansible-tmp-1644758572.6873014-53129-261001537130544/AnsiballZ_file.py && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'rm -f -r /root/.ansible/tmp/ansible-tmp-1644758572.6873014-53129-261001537130544/ > /dev/null 2>&1 && sleep 0'"]
ok: [centos7] => {
    "changed": false,
    "diff": {
        "after": {
...
<centos7> ESTABLISH DOCKER CONNECTION FOR USER: root
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'echo ~ && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', '/bin/sh -c \'( umask 77 && mkdir -p "` echo /root/.ansible/tmp `"&& mkdir "` echo /root/.ansible/tmp/ansible-tmp-1644758574.9682555-53290-52382250532570 `" && echo ansible-tmp-1644758574.9682555-53290-52382250532570="` echo /root/.ansible/tmp/ansible-tmp-1644758574.9682555-53290-52382250532570 `" ) && sleep 0\'']
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'test -e /opt/jdk/11.0.14/bin/java && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'rm -f -r /root/.ansible/tmp/ansible-tmp-1644758574.9682555-53290-52382250532570/ > /dev/null 2>&1 && sleep 0'"]
skipping: [centos7] => {
    "changed": false,
...
<centos7> ESTABLISH DOCKER CONNECTION FOR USER: root
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'echo ~ && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', '/bin/sh -c \'( umask 77 && mkdir -p "` echo /root/.ansible/tmp `"&& mkdir "` echo /root/.ansible/tmp/ansible-tmp-1644758576.2309973-53410-214112086616035 `" && echo ansible-tmp-1644758576.2309973-53410-214112086616035="` echo /root/.ansible/tmp/ansible-tmp-1644758576.2309973-53410-214112086616035 `" ) && sleep 0\'']
Using module file /usr/local/lib/python3.8/dist-packages/ansible/modules/stat.py
<centos7> PUT /root/.ansible/tmp/ansible-local-52645m60ddudn/tmp81lbiyq6 TO /root/.ansible/tmp/ansible-tmp-1644758576.2309973-53410-214112086616035/AnsiballZ_stat.py
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'chmod u+x /root/.ansible/tmp/ansible-tmp-1644758576.2309973-53410-214112086616035/ /root/.ansible/tmp/ansible-tmp-1644758576.2309973-53410-214112086616035/AnsiballZ_stat.py && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c '/usr/bin/python /root/.ansible/tmp/ansible-tmp-1644758576.2309973-53410-214112086616035/AnsiballZ_stat.py && sleep 0'"]
<centos7> EXEC ['/usr/bin/docker', b'exec', b'-i', 'centos7', '/bin/sh', '-c', "/bin/sh -c 'rm -f -r /root/.ansible/tmp/ansible-tmp-1644758576.2309973-53410-214112086616035/ > /dev/null 2>&1 && sleep 0'"]
changed: [centos7] => {
    "changed": true,
    "diff": [],
    "invocation": {
        ...
        "module_args": {
            ...
            "follow": false,
            "mode": null,
            "src": "/root/.ansible/tmp/ansible-local-52645m60ddudn/tmp9iqbg5_o/jdk.sh.j2"
        },
        "src": "/root/.ansible/tmp/ansible-local-52645m60ddudn/tmp9iqbg5_o/jdk.sh.j2"
    }
}
...
root@server1:~/learning-ansible/Lesson-ansible-02/ansible-02-playbook# vim 3-site.yml 
root@server1:~/learning-ansible/Lesson-ansible-02/ansible-02-playbook# 
root@server1:~/learning-ansible/Lesson-ansible-02/ansible-02-playbook# ansible-playbook -i inventory/3-prod.yml 3-site.yml --check -vvv
ansible-playbook [core 2.12.2]
  config file = None
