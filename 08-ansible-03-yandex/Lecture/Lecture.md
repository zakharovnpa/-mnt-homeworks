...
- 01:18:00 - Создание в Яндекс.Облаке ВМ
- 01:21:00 - запуск playbook

- 01:41:25 - первый запуск и настройка файла-конфига Кибаны
- 01:48:55 - запуск ` ansible-playbook ` после подготовки файла-конфига Кибаны
- 01:49:43 - проверка работоспособности Кибаны ` curl https://localhost:5601 `
