...
- 01:24:30 - после выполнения плейбука вход на Вм и контроль установки Elastic `sudo systemctl status elasticserach`, `curl http://27.0.0.1:9200`  в результате получаем вывоод ямльника. Затем по ип адресу заходим на страницу в браузере, там тоже на выводе ямльник.
