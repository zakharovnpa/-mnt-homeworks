# Домашнее задание к занятию "09.01 Жизненный цикл ПО" - Захарв Сергей Николаевич
...
Выгружены файлы .XML:
1. [Файл workflow для задач типа bug](/09-ci-01-intro/Files/For-ZSN-1-only-bug.xml)

2. [Файл workflow для остальных типов задач](/09-ci-01-intro/Files/For-ZSN-1-only-other-tasks.xml)
