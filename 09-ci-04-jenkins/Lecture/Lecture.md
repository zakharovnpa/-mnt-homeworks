...
разработанный, как дополнение к java.
- Apache 2 License
...
- Package hudson
  - hudson.*
  - hudson.model.*
Для полноценного использования можно ознакомится с содержимым официальной страницы
```
...
Registry. Особенности настройки и работы можно посмотреть на
странице.
