...
Также причина может быть в образовании большого количества текстовых файлов (отчетов) и их передача по сети.
...
2. Згрузка CPU
3. Размер SWAP
4. HDD - производительность при
5. OS - очередь на передачу данных
6. 
7. 
