...
| Метрика |Назначение|
|:-|:-|
загрузка RAM |  контроль за потреблением
загрузка CPU |  контроль за нагрузкой
...
кол-во созданных файлов нужного формата в контролируемом каталоге| для статистики и контроля нагрузки на файловую систему
кол-во удаленных файлов нужного формата в контролируемом каталоге| для статистики и контроля нагрузки на файловую систему
минимальный размер создаваемого файла нужного формата| для статистики и контроля нагрузки на файловую систему
максимальный размер создаваемого файла нужного формата| для статистики и контроля нагрузки на файловую систему
кол-во создаваемых файлов размером менее 10кб| для статистики и контроля нагрузки на файловую систему
кол-во сессий TCP в состоянии `TIME-WAIT`, `ESTABLISHED`, `SYN-SENT`, `CLOSING` | для контроля нагрузки на процесс передачи данных
...
5. Мой выбор системы:
  - приоритетно - Sentry. Т.к. бесплатная и специализированная
  - менее приоритетно - Prometheus + Nodexporter + Grafana. Также бесплатная, но более универсальная по решаемым задачам.
